...
// filtersim class
class GEOSTAT_DECL Filtersim_Std: public Geostat_algo 
{
public:
	Filtersim_Std();
	~Filtersim_Std();
	...
	virtual std::string name() const { return "filtersim_std"; }
...
private:
    ...
    bool valid_filter_file( int nxdt, int nydt, int nzdt, string filter_file_name );
...
private:
    ...
    vector< PrototypeListType1 > proto_list1_;
    vector< PrototypeListType2 > proto_list2_;
