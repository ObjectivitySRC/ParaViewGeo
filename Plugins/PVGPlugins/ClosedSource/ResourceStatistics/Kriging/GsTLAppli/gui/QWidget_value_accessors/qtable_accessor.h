...
class GUI_DECL QTable_accessor : public QWidget_value_accessor { 
 public: 
  static Named_interface* create_new_interface(std::string&); 
 
 public: 
  QTable_accessor( QWidget* widget = 0 ); 
  virtual ~QTable_accessor() {} 
 
  virtual bool initialize( QWidget* widget = 0 ); 
  virtual bool is_valid() const { return table_ != 0; } 
