...
#include <GsTLAppli/grid/grid_model/rgridgeometry.h>
#include <GsTLAppli/grid/grid_model/grid_iterators.h>
#include <GsTLAppli/grid/grid_model/grid_gval_accessor.h>
...
int main( int argc, char* argv[]) {
    ...
    Gval_iterator end =  rgrid1.random_path_end();
    
    for (Gval_iterator it = rgrid1.random_path_begin(); it != end; it++) {
        ii++;
        float val = ii;
