...
class Rgrid_window_neighborhood : public Window_neighborhood { 
public:
...
class Rgrid_ellips_neighborhood : public Neighborhood { 
public:
  typedef Geovalue value_type; 
  typedef Neighborhood::iterator iterator; 
  typedef Neighborhood::const_iterator const_iterator; 
 ...
 */ 
class Rgrid_ellips_neighborhood_hd : public Rgrid_ellips_neighborhood { 
public:
  typedef Geovalue value_type; 
  typedef Neighborhood::iterator iterator; 
  typedef Neighborhood::const_iterator const_iterator; 
