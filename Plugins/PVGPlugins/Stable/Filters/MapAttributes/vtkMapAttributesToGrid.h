/*=========================================================================
  ...
  Module:    $ vtkMapAttributesToGrid.h $
...
#ifndef __vtkMapAttributesToGrid_h
#define __vtkMapAttributesToGrid_h
...
class VTK_EXPORT vtkMapAttributesToGrid : public vtkImageAlgorithm
{
public:
  static vtkMapAttributesToGrid *New();
  vtkTypeRevisionMacro(vtkMapAttributesToGrid,vtkImageAlgorithm);
...
private:
  ...
  vtkMapAttributesToGrid(const vtkMapAttributesToGrid&);  // Not implemented.
  void operator=(const vtkMapAttributesToGrid&);  // Not implemented.
};
