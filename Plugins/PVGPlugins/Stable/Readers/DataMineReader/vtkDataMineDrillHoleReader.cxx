...
vtkCxxRevisionMacro(vtkDataMineDrillHoleReader, "$Revision: 0.5 $");
...
// --------------------------------------
void vtkDataMineDrillHoleReader::ParsePoints( vtkPoints* points, vtkCellArray *cells, 
		TDMFile *file,const int & XID, const int & YID, const int & ZID, const int & BHID, const int & BHIDSize )
{		
