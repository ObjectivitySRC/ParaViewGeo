...
vtkCxxRevisionMacro(vtkDataMinePerimeterReader, "$Revision: 0.6 $");
...
// --------------------------------------	
void vtkDataMinePerimeterReader::ParsePoints(vtkPoints* points, vtkCellArray *cells, TDMFile *file, const int &XID, const int &YID, const int &ZID, const int &PTN, const int &PV )
{
