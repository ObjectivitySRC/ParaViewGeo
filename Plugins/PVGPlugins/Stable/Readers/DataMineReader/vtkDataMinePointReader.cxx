...
vtkCxxRevisionMacro(vtkDataMinePointReader, "$Revision: 0.4 $");
...
// --------------------------------------	
void vtkDataMinePointReader::ParsePoints( vtkPoints* points, vtkCellArray *cells, TDMFile *file,const int &XID,const int &YID,const int &ZID )
{
