...
for key in k:
  r,g,b = map(convert,hex_to_rgb( colors[key] ))
  line = '  this->AddColor("'+key+'",'+r+'f,'+g+'f,'+b+'f);\n'
  f.write(line)
f.close()
