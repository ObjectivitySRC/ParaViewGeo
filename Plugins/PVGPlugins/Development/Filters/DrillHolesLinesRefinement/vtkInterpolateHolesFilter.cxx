/*=========================================================================
  ...
  Module:    $ vtkInterpolateHolesFilter.cxx $
...
//----------------------------------------------------------------------------
/*void vtkInterpolateHolesFilter::SetSourceConnection ( vtkAlgorithmOutput* algOutput )
{
	...
	if(this->TypeOfInterpolation==1)//polylinear interpolation 
	{
		...
		{	
			...
			{ 
				...
				if(abs(cosAlpha)<0.996194698 )//cos(175)=-0,996194698
				{
